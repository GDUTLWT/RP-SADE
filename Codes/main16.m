...
for j = 16:20
    ...
    if j ==16
        save c16_fval_CEC0716 Fval
        save c16_nfe_CEC0716 NFE 
        save c16_X_paper_CEC0716 X_paper 
        Fval = zeros(25,1);
        NFE = zeros(25,1);
        X_paper = zeros(30,25);
    end
    ...
    if j ==17
        save c17_fval_CEC0716 Fval
        save c17_nfe_CEC0716 NFE 
        save c17_X_paper_CEC0716 X_paper 
        Fval = zeros(25,1);
        NFE = zeros(25,1);
        X_paper = zeros(30,25);
    end
    ...
    if j ==18
        save c18_fval_CEC0716 Fval
        save c18_nfe_CEC0716 NFE 
        save c18_X_paper_CEC0716 X_paper 
        Fval = zeros(25,1);
        NFE = zeros(25,1);
        X_paper = zeros(30,25);
    end
    ...
    if j ==19
        save c19_fval_CEC0716 Fval
        save c19_nfe_CEC0716 NFE 
        save c19_X_paper_CEC0716 X_paper 
        Fval = zeros(25,1);
        NFE = zeros(25,1);
        X_paper = zeros(30,25);
    end
    ...
    if j ==20
        save c20_fval_CEC0716 Fval
        save c20_nfe_CEC0716 NFE 
        save c20_X_paper_CEC0716 X_paper 
        Fval = zeros(25,1);
        NFE = zeros(25,1);
        X_paper = zeros(30,25);
    end
